...
def load_config(nbapp):
    ...
    """
    from .handlers import LabConfig
...
def load_jupyter_server_extension(nbapp):
    ...
    from .lab_handlers.build_handler import build_path, Builder, BuildHandler
    from .lab_handlers.extension_manager_handler import (
        extensions_handler_path, ExtensionManager, ExtensionHandler
    )
    from .lab_handlers.error_handler import ErrorHandler
    from .commands import (
