...
/**
 * A wrapped implementation of an `IModelDB`.
 */
export class WrappedModelDB implements IModelDB {
  /**
   * Constructor for the `ModelDB`.
   */
  constructor(options: WrappedModelDB.ICreateOptions = {}) {
  ...
  view(basePath: string): IModelDB {
    const view = new WrappedModelDB({ basePath, baseDB: this });
 ...
 */
export namespace WrappedModelDB {
  /**
